...
def main(args,root,y,path,data_root,route_run_folder):
    """
    ...
    generate_scene_artifact_files(path,scene_config,sampler,folder,simulation_run,route_path,y,data_path,total_scenes,data_file,scene_num,route_run_folder,args.tracks)
...
def create_root_folder(args,path):
    ...
    for folder in folders:
        ...
        roots.append(root)
        route_run_folder = path + "/" + args.routes_folder + "/" + "run%d"%y + "/"

    return paths, y, roots[0], route_run_folder
...
if __name__ == '__main__':
        ...
        root,y,data_root, route_run_folder = create_root_folder(args,path)
        #print(root,y,data_root)
        main(args,root,y,path,data_root,route_run_folder)
