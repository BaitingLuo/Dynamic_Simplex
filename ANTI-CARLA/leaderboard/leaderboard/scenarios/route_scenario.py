...
class RouteScenario(BasicScenario):
    ...
    def _update_route(self, world, config, debug_mode):
        ...
        gps_route, route, wp_route, scene_gps = interpolate_trajectory(world, config.trajectory)
        ...
        config.agent.set_global_plan(gps_route, self.route, wp_route,scene_gps,config.trajectory)
    ...
    def _initialize_actors(self, config):
        ...
        town_amount = {
            'Town01': 120,
            'Town02': 100,
            'Town03': 120, #self.traffic_amount,
            'Town04': 200,
            'Town05': 150, #self.traffic_amount,
            'Town06': 150,
            'Town07': 110,
            'Town08': 180,
            'Town09': 300,
